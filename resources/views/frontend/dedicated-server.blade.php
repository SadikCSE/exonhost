    ...
    <div class="white padseptente" >
        <div class="content">
            ...
            <div class="flex-grid centered" style="margin-bottom:75px">
                ...
                <div class="onefird">
                    <h3>1 Gbps Dedicated Port</h3>
                    <img src="{{asset('frontend/images')}}/speed.png" width="94" height="94" alt="">
                    <p>All of our server comes with 1Gbps Uplink Port as a standard.</p>
                </div>
                <div class="onefird">
